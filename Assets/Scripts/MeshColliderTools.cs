...
static public class MeshColliderTools {
    ...
    public static void Weld(this Mesh mesh, float bucketStep) {
        ...
        int newSize = 0;
        if (oldVertices.Length == 0) return;
        ...
        //Debug.Log("bucket: " + bucketSizeX + ", vert: " + oldVertices.Length);
    ...
    private class Edge {
        ...
        public static void Collapse(Edge moved, Edge target, Face f) {
            ...
            try { faceOutsideMoved = moved.GetOpposite(f); } catch (Exception e) {
